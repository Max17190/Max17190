...
**[Amazon Inventory Monitor](https://github.com/Max17190/amazon-monitor)** Real-time restock monitor for high-demand Amazon products, async batch polling with transition alerts for restocks. 109 ms p50 restock latency from us-east-1.
